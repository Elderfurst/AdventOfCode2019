...
namespace AdventOfCode2019
{
    public class Day2
    {
        private static readonly long[] Inputs = File.ReadAllText(@"Inputs/Day2.txt").Split(',').Select(long.Parse).ToArray();
        public void Run()
        {
        ...
        private long PartOne(int noun, int verb)
        {
            var inputs = new long[Inputs.Length];
